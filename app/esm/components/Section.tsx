...
/**
 * Standard content section — same template as ITSM Section.
 * No kickers (per visual-cleanliness rule). Hierarchy via heading scale only.
 */
    ...
    >
      <div className="mx-auto max-w-[1280px]">
        <div className={`reveal mb-12 max-w-[720px] md:mb-[4.5rem] ${headerLayout} ${headerClassName}`}>
          <h2
            id={headingId}
            className="text-[clamp(2rem,4.5vw,3.5rem)] font-extralight tracking-tight leading-[1.05]"
          >
            {title}
          </h2>
          {lead ? (
